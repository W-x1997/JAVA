...
<html>
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-2" data-genuitec-path="/Hibernate_demo/WebRoot/query.jsp">
    <div class="main" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-2" data-genuitec-path="/Hibernate_demo/WebRoot/query.jsp">
    	<div class="login">
