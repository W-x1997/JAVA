...
<html>
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-3" data-genuitec-path="/Hibernate_demo/WebRoot/query_success.jsp">
  QUERY SUCCESS
  <s:property value="#user.getAge()"/></td>
<s:property value="#user.getUsername()"/></td>
