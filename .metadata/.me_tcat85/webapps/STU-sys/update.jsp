...
<html>
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-7" data-genuitec-path="/STU-sys/WebRoot/update.jsp">
    <div class="main" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-7" data-genuitec-path="/STU-sys/WebRoot/update.jsp">
    	<div class="check">
