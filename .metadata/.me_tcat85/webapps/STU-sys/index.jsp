...
<html>
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-2" data-genuitec-path="/STU-sys/WebRoot/index.jsp">
    <div class="main" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-2" data-genuitec-path="/STU-sys/WebRoot/index.jsp">
    	<div class="login">
	    	<div class="title">µÇÂ¼</div>
	    	<form action="login.action" method="post">
	    		...
	    		<input class="button" type="reset" value="ÖØÖÃ"/>
	    	</form>
    	</div>
    </div>
  </body>
